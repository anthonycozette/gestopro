    ...
    const features = [
        {
            ...
            description:
                "Créez et gérez vos factures en quelques clics. Suivez vos clients et leurs paiements en temps réel.",
            color: "text-blue-500",
        },
        {
            icon: Calculator,
            ...
            description:
                "Calculez automatiquement vos cotisations selon les règles officielles. Zéro erreur, zéro stress.",
            color: "text-cyan-500",
        },
        {
            icon: Brain,
            ...
            description:
                "Générez votre bilan comptable complet avec l'IA. Analyses, recommandations et projections incluses.",
        ...
        },
        {
            ...
            description:
                "Photographiez vos reçus et factures. L'IA extrait automatiquement toutes les données importantes.",
        ...
        },
        {
            ...
            description:
                "Collaborez avec votre expert-comptable. Validation, signature et annotations en ligne.",
        ...
        },
        {
            ...
            description:
                "RGPD, hébergement France, chiffrement AES-256. Vos données sont protégées.",
            color: "text-red-500",
        },
    ];
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
            ...
            <section className="relative overflow-hidden pt-20 pb-16 sm:pt-32 sm:pb-24">
                ...
                <div className="absolute inset-0 -z-10">
                    ...
                    <div
                        className="absolute top-20 right-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl animate-float"
                        style={{ animationDelay: "1s" }}
                    ></div>
                    <div
                        className="absolute bottom-0 left-1/2 w-96 h-96 bg-cyan-500/20 rounded-full blur-3xl animate-float"
                    ...
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full bg-white/5 px-4 py-2 backdrop-blur-sm border border-white/10">
                            ...
                            <span className="text-sm text-gray-300">
                                Propulsé par l'IA Claude Enterprise
                            </span>
                        </div>
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-300 max-w-2xl mx-auto">
                            Factures, URSSAF, bilans : automatisez votre
                            comptabilité en 10 minutes. L'IA s'occupe du reste
                            pendant que vous développez votre business.
                        </p>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="mx-auto max-w-2xl text-center mb-16">
                        ...
                        <p className="text-lg text-gray-400">
                            GestoPro centralise tous les outils essentiels pour
                            gérer votre micro-entreprise efficacement.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {features.map((feature) => {
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className={`inline-flex rounded-lg p-3 bg-white/5 mb-5 ${feature.color}`}
                                    >
            ...
            <section
                id="pricing"
                className="py-24 sm:py-32 bg-white/5 backdrop-blur-sm border-y border-white/10"
            >
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    {/* Section header */}
                    <div className="mx-auto max-w-2xl text-center mb-16">
                        ...
                        <p className="text-lg text-gray-400">
                            Commencez gratuitement pendant 14 jours. Sans
                    ...
                    <div className="relative overflow-hidden rounded-3xl bg-gradient-brand p-12 lg:p-20 text-center">
                        <div className="relative z-10">
                            ...
                            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                                Rejoignez les 2500+ auto-entrepreneurs qui
                                gagnent 45h par mois avec GestoPro.
                            </p>
                            <Link
                                href="/register"
